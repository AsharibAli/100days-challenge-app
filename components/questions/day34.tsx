    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <p>Use the JavaScript Math object to find the square root of 144.</p>
          <div className="p-2">
            <AlertDialog>
 ...
 console.log(daysUntilNewYear() + " days until New Year.");
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <p>Generate a random integer between 1 and 10.</p>
          <div className="p-2">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="outline">Show Answer 👀</Button>
...
`}
      ...
      <CardContent>
        ...
        <div className="space-y-4">
          ...
          <p>
            Calculate and log the absolute difference between the number -5 and
            5.
          </p>
          <div className="p-2">
            <AlertDialog>
              ...
              <AlertDialogContent className="w-full max-w-2xl p-4 md:p-6">
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    <strong> ➡️ Explanation of Question 102</strong>
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    {`

...
const Day40 = () => {
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <p>Write a loop that logs numbers from 1 to 10 to the console.</p>
          <div className="p-2">
            <AlertDialog>
 ...
 function daysUntilNewYear(): number {
   ...
   const days = Math.ceil(diff / (1000 * 60 * 60 * 40)); 
   return days;
 }
 ...
 console.log(daysUntilNewYear() + " days until New Year.");
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <p>Create a while loop that logs `Hello, World!` 5 times.</p>
          <div className="p-2">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="outline">Show Answer 👀</Button>
...
`}
      ...
      <CardContent>
        ...
        <div className="space-y-4">
          ...
          <p>
            Use a for...of loop to iterate through an array of your favorite
            movies and log each one.
          </p>
          <div className="p-2">
            <AlertDialog>
              <AlertDialogTrigger asChild>
              ...
              <AlertDialogContent className="w-full max-w-2xl p-4 md:p-6">
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    <strong> ➡️ Explanation of Question 120</strong>
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    {`
